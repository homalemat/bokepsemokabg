...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepsemokabg.pages.dev/v/${file.filecode}#${file.title}`,
